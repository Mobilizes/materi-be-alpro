...
import (
	"github.com/Mobilizes/materi-be-alpro/modules/$MODULE_NAME/service"
	"github.com/Mobilizes/materi-be-alpro/modules/$MODULE_NAME/validation"
...
import (
	"github.com/Mobilizes/materi-be-alpro/modules/$MODULE_NAME/repository"
	"gorm.io/gorm"
)
...
import (
	"github.com/Mobilizes/materi-be-alpro/modules/$MODULE_NAME/controller"
